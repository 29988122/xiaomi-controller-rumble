...
def package(root, profile, dest):
    ...
    fields = {'G8FF_KERNEL': info['kernel_release'], 'G8FF_FINGERPRINT': info['fingerprint'], 'G8FF_SHA256': info['module_sha256']}
    ...
    data['disable'] = data['skip_mount'] = b''
    ...
    with zipfile.ZipFile(dest, 'w', zipfile.ZIP_STORED, compresslevel=9) as z:
        for name, content in sorted(data.items()):
            ...
            item.external_attr = (0o100700 if name in ['bin/g8ffctl','bin/ff_test'] else 0o100600) << 16
